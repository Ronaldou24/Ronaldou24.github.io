...
if (isset($_POST["BookID"])) {
    ...
    $id_borrar = mysqli_real_escape_string($conn, $_POST["BookID"]);

    // Construye la consulta SQL para obtener los datos del cliente antes de eliminarlo
    $query = "SELECT BookID, Title, Author, Published, Barcode FROM books WHERE BookID = '$id_borrar'";
...
<body>
    ...
    <table>
        <tr>
            <th>Valores</th>
            <th>Datos del Libro Eliminado</th>
        </tr>
        <tr>
            <td>ID</td>
            <td><?php echo $ID; ?></td>
    ...
    <br>
    <a href="inventario.php">Ver tabla actualizada</a>
</body>
</html>
<?php
        } else {
